...
# parser.add_argument('--lr_decrease_patience', type=int, default=3) # after how many sequential non improving training steps should the lr decrease
# parser.add_argument('--early_stop_patience', type=int, default=10) # after how many lr decreases should the training stop
