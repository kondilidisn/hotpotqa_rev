...
#        logging("Sentence embedding shape : "+str(sentence_embeddings.shape),self.config.save)
#        logging("Sentence length shape : "+str(sentence_length.shape),self.config.save)
#        logging("Sentence length : "+str(sentence_length),self.config.save)
        sentence_mask = (sentence_embeddings > 0).float()
...
#        sentence_mask = sentence_length
        
#        sentence_mask = (sentence_mask > 0).float()
