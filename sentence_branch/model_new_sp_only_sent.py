...
class SPModel(nn.Module):
    def __init__(self, config, word_mat, char_mat):
        ...
        self.self_att_sentences = BiAttention(config.hidden*2, 1-config.keep_prob)
...
#        sentence_self_attension_out = self.self_att_sentences(sentence_rnn_out,sentence_rnn_out,sentence_mask)
