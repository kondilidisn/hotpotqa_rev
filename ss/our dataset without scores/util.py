...
class DataIterator(object):
    ...
    def __iter__(self):
        ...
        is_support = torch.zeros(self.bsz, self.sent_limit).cuda()

        sentence_scores = torch.zeros(self.bsz, self.sent_limit).cuda()
        ...
        while True:
            ...
            for i in range(len(cur_batch)):
                ...
                retrieved_sentence_scores =  cur_batch[i]['sentence_scores']
                # print('retrieved_sentence_scores size : ', retrieved_sentence_scores.size())

                sentence_scores[i][:retrieved_sentence_scores.size()[0]].copy_(retrieved_sentence_scores)

                # print('Sentence scores :')

                # print(sentence_scores[i])
            ...
            yield {'context_idxs': context_idxs[:cur_bsz, :max_c_len].contiguous(),
                ...
                'sentence_scores': sentence_scores[:cur_bsz, :max_sent_cnt],
